...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center mt-4">
            <div class="col-sm-12 col-md-8 col-lg-6 col-xl-5 form-container" style='Background-color: #2ef2e8;  border: none;'>
                ...
                <form  action="regnew.php" method="post">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg mt-3" name="action"
                        value="reg" style='Background-color: rgb(5, 92, 92);  border: none;'>Register</button>
