                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" class="form-check-input" id="InSem" name="exam" value="InSem" required>
                                <label class="form-check-label" for="InSem">InSem</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input type="radio" class="form-check-input" id="EndSem" name="exam" value="EndSem">
                                <label class="form-check-label" for="EndSem">EndSem</label>
                            </div>

                        </div>

                        <div class="input-group mb-3">
                            <label class="input-group-text btn btn-primary" for="inputGroupFile02"style=' background-color: rgb(5, 92, 92);  border: none;'>Choose File</label>
                            <input type="file" class="form-control" name="pdf_file" id="inputGroupFile02" required>
                        </div>

                        <button type="submit" class="btn upbt btn-primary" name="upload" style=' background-color: rgb(5, 92, 92);  border: none;'>Upload PDF file</button>
                    </form>
                </div>
            </div>
        </div>
