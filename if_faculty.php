...
<body>
        ...
        <table class="table table-striped">
            <thead class="table-header">
                <tr>
                    ...
                    <th style = " background-color: #2ef2e8;">Feedback</th>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<button class='btn btn-primary' type='submit' name='reupload' style=' background-color: rgb(5, 92, 92);  border: none;'>Reupload</button>";
                    echo "</form>";
                    echo "</td>";
                    echo "</tr>";
                }
    ...
    <button type='submit' class="btup btn btn-primary" name='upload' onclick="redirectTo('IFUpload.php')" style=' background-color: rgb(5, 92, 92);  border: none;'>Upload a new Question Paper</button>
