    ...
    <div class="container" >
        <div class="row justify-content-center mt-4">
            <div class="col-sm-12 col-md-8 col-lg-6 col-xl-5 form-container">
                <h2>Updation of Verifier</h2>
                <form action="hodupd.php" method="POST">
                    <div class="form-group" style = " background-color: #2ef2e8;" >
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if (isset($_POST["action"])) {
        ...
        if (mysqli_query($conn, $sql)) {
            $message = 'Verifier Updation Successful';
            echo "<script>showAlert('$message');</script>";
        } else {
            $message = 'Error Updating Verifier record : ' . mysqli_error($conn);
            echo "<script>showAlert('$message');</script>";
        }
        exit();
        // }
